...
For the profiling workflow itself, see [How to Identify Build-Time Bottlenecks Using CPU Profiling](/blogs/how-to-identify-build-time-bottlenecks-using-cpu-profiling).
